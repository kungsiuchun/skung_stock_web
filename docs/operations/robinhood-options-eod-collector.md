...
- Expiries: first four valid, active expiry dates from a tradable, non-adjusted chain.
...
2. Require all 50 symbols, one to four expiries per symbol, unique `expiry:strike:callPut`, valid ±20% bounds, current quotes, and schema `1.0`.
